...
EnemyII::EnemyII() {
	...
	hpTxt.setFillColor(sf::Color::Magenta);
	ss << 100;
	hpTxt.setString(ss.str());
	ss.str("");
	amountEnemyTxt.setFont(font);
	amountEnemyTxt.setCharacterSize(50);
	amountEnemyTxt.setFillColor(sf::Color::Red);
	amountEnemyTxt.setPosition(1000, 500);
	ss << 0;
	amountEnemyTxt.setString(ss.str());
	ss.str("");
	//
}
EnemyII::~EnemyII() {
...
/*
	if (!enemyS.empty()) {
		...
		r.setPosition(enemyS[0].getPosition().x, enemyS[0].getPosition().y);
		window.draw(r);
		...
		r2.setPosition(enemyS[0].getPosition().x, enemyS[0].getPosition().y + 144);
		window.draw(r2);
	}*/
	

	nEnemy.setFont(font);
	nEnemy.setCharacterSize(50);
	std::stringstream ss;
	ss << cntEnemyDead;
	nEnemy.setString(ss.str());
	nEnemy.setPosition(200, 600);
	ss.str("");
	window.draw(nEnemy);

	boolSpawn.setFont(font);
	boolSpawn.setCharacterSize(50);
	ss << isEnemyAllDied;
	boolSpawn.setString(ss.str());
	boolSpawn.setPosition(300, 600);
	window.draw(boolSpawn);
	ss.str("");
	_maxEnemy.setFont(font);
	_maxEnemy.setCharacterSize(50);
	ss << maxEnemy;
	_maxEnemy.setString(ss.str());
	_maxEnemy.setPosition(100, 600);
	window.draw(_maxEnemy);
