...
private:
	...
	float verticalSpeed = defaultSpeed - 2.0f;

	sf::Vector2f scale{ 3.6f,3.6f };

	short healthPlayer = 1000;
	unsigned short energyPlayer = 100;
	...
	float bulletSpeed = defaultSpeed;

	sf::Texture playerTT, bodyTT, bulletTT;

	const std::string  playerFile = "Sprite/PlayerII/whole.png";
	const std::string bodyFile = "Sprite/PlayerII/body.png";
	const std::string bulletFile = "Sprite/PlayerII/weapon.png";
...
public:
	...
	unsigned short updateHealthPlayer();
	...
	void healing();
	void itemAffect(const unsigned short itemSelected);
