...
void EnemyI::requestHealthPlayer(const short healthPlayer) {
...
bool EnemyI::updateScore() {
	return isEnemyDied;
}

unsigned short EnemyI::updateHealthMiss() {
	if (isHealthMiss) {
		isHealthMiss = false;
		return 1;
	}
...
unsigned short EnemyI::updateEnergyPlayer() {
