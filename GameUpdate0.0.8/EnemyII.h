...
private:
	...
	const short maxLane = 4;
	const std::vector<short> spawnPos{ 214, 414, 614 , 814 };
	...
	const float defaultBulletSpeed = 90;
	const float minBulletSpeed = 50;
	float bulletSpeed = defaultBulletSpeed;
	const float bulletMoveTime = 0.2f;
	...
	// text font
	sf::Font font;
	sf::Text hpTxt, amountEnemyTxt;
	std::vector<sf::Text> hpEnemyTxt;
	//
