...
MainMenu::MainMenu() {
	...
	gameDev.setCharacterSize(30);
	gameDev.setString("65010539 Nitcharat Thatthiam");
	gameDev.setOrigin(gameDev.getGlobalBounds().width / 2, gameDev.getGlobalBounds().height / 2);
	gameDev.setPosition(1919 - gameDev.getGlobalBounds().width / 2 - 30, 1079 - gameDev.getGlobalBounds().height - 60);
