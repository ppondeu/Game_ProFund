...
void Player::playerRender(float deltaTime) {
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space)) {
		...
		if (side == "right") {
			...
			if (indexAttack % 3 == 0) updateValue("attack", "right", 0.0f, "sprite/player_attack_1_rs.png", 9);
			else if(indexAttack % 3== 1) updateValue("attack", "right", 0.0f, "sprite/player_attack_2_rs.png", 7);
			else if (indexAttack %3== 2) updateValue("attack", "right", 0.0f, "sprite/player_attack_3_rs.png", 10);

		}
		if (side == "left") {

			if (indexAttack%3 == 0) updateValue("attack", "left", 0.0f, "sprite/player_attack_1_ls.png", 9);
			else if (indexAttack%3== 1) updateValue("attack", "left", 0.0f, "sprite/player_attack_2_ls.png", 7);
			else if (indexAttack %3== 2) updateValue("attack", "left", 0.0f, "sprite/player_attack_3_ls.png", 10);
		}
